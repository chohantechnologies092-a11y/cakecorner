    ...
    <div style={{ maxWidth: "600px", margin: "0 auto" }}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          ...
          <input type="text" name="name" required style={{ padding: "0.8rem", borderRadius: "8px", border: "1px solid #ddd" }} />
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          <label style={{ fontWeight: "bold" }}>Email Address</label>
          <input type="email" name="email" required style={{ padding: "0.8rem", borderRadius: "8px", border: "1px solid #ddd" }} />
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          <label style={{ fontWeight: "bold" }}>Password</label>
          <input type="password" name="password" required minLength={6} style={{ padding: "0.8rem", borderRadius: "8px", border: "1px solid #ddd" }} />
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          <label style={{ fontWeight: "bold" }}>Role</label>
          <select name="role" required style={{ padding: "0.8rem", borderRadius: "8px", border: "1px solid #ddd", background: "white" }}>
