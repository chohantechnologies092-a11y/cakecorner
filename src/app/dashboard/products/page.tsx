                  ...
                  <tr key={product.id} className={styles.tableRow} style={{ borderBottom: "1px solid var(--color-border-glass, #f0f0f0)" }}>
                    ...
                    <td style={{ padding: "1.2rem 1.5rem", textAlign: "right" }}>
                      <div style={{ display: "flex", gap: "0.5rem", justifyContent: "flex-end" }}>
                        <Link href={`/product/${product.id}`} target="_blank" style={{ padding: "0.4rem 1rem", background: "var(--color-background-glass, #f0fdfa)", border: "1px solid var(--color-border-glass, #ccfbf1)", borderRadius: "8px", fontSize: "0.85rem", fontWeight: "600", textDecoration: "none", color: "var(--color-primary, #0f766e)" }}>View</Link>
