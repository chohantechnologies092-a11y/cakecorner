                  ...
                  <tr key={order.id} style={{ borderBottom: "1px solid #f0f0f0" }}>
                    ...
                    <td style={{ padding: "1rem 1.5rem" }}>
                      ...
                      <div style={{ display: "flex", gap: "0.4rem", marginTop: "0.3rem" }}>
                        <span style={{ background: isPickup ? "#fef3c7" : "#e0f2fe", color: isPickup ? "#b45309" : "#0369a1", padding: "0.15rem 0.5rem", borderRadius: "4px", fontSize: "0.7rem", fontWeight: "600" }}>
                          {isPickup ? "🏬 Pickup" : "🚚 Delivery"}
                        </span>
                        <span style={{ background: order.paymentStatus === "Paid" ? "#dcfce7" : "#f3f4f6", color: order.paymentStatus === "Paid" ? "#15803d" : "#4b5563", padding: "0.15rem 0.5rem", borderRadius: "4px", fontSize: "0.7rem", fontWeight: "600" }}>
                    ...
                    <td style={{ padding: "1rem 1.5rem" }}>
                      <span style={{ background: colors.bg, color: colors.color, padding: "0.25rem 0.75rem", borderRadius: "12px", fontSize: "0.8rem", fontWeight: "600" }}>
                        {order.status}
                      </span>
                    </td>
                    <td style={{ padding: "1rem 1.5rem", color: "#888", fontSize: "0.85rem" }}>
